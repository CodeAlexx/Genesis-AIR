...
|---|---|---|
| Timeline, pool, tracks, transport, undo/redo | Command/state gate, save/reload, drag undo step; generated-media preview/export and X11 Play/Pause for representative cases; Crossfade, the UI's Dissolve, and an overlapping midpoint seam have preview/MP4 gates; all 11 transition names map to worker ids | Media outcomes for every edit operation, nested sequences, media gates for the other nine transition kinds and short-gap seams, fast interactive preview. |
